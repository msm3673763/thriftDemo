...
/**
 * 
* @ClassName: CAPrinciple 
* @Description: CA认证原理（java实现仿） 
* @author masm
* @date 2017-4-19 下午5:16:02 
* @version V1.0
 */
public class CAPrinciple {
	 ...
	 * @throws Exception
	 */
	public static byte[] encryptByPriateKey(byte[] data, String keyStorePath,
			String alias, String password) throws Exception {
		//获得私钥
	 ...
	 * @throws Exception
	 */
	public static byte[] sign(byte[] sign, String keyStorePath,
			String alias, String password) throws Exception {
		//获得证书
	...
	public static void test1() throws Exception {
		...
		//公钥加密
		byte[] encrypt = encryptByPublicKey(data, "D:/ssl/client.cer");
		//私钥解密
		byte[] decrypt = decryptByPrivateKey(encrypt, "d:/ssl/tomcat.keystore", "alias", "123456");
	...
	public static void test2() throws Exception {
		...
		byte[] data = inputStr.getBytes();
		//私钥加密
		byte[] encodedData = encryptByPriateKey(data, "d:/ssl/tomcat.keystore", "alias", "123456");
		//公钥加密
		byte[] decodeData = decryptByPublicKey(encodedData, "d:/ssl/client.cer");
	...
	* @version V1.0
	...
	public static void testSign() throws Exception {
		...
		//产生签名
		byte[] sign = sign(data, "d:/ssl/tomcat.keystore", "alias", "123456");
		System.err.println("签名:\n" + Hex.encodeHexString(sign));
		//验证签名
		boolean status = verify(data, sign, "d:/ssl/client.cer");
